...
tabs.push(pp);
_323(_328,pp,_329);
opts.onAdd.call(_328,_329.id,tabs.length-1);// 换成ID
_307(_328);
if(_329.selected){
...
var pp=_32d.tab;
var _32f=pp.panel("options").id;// 换成ID
...
_307(_32c);
$.data(_32c,"tabs").options.onUpdate.call(_32c,opts.id,_333(_32c,pp));//换成ID
};
...
var _33a=tab.panel("options").id;//换成ID
...
_349.panel("open");
var _34c=_349.panel("options").id;//换成ID
_348.push(_34c);
...
_351.options.onUnselect.call(_34f,opts.id,_333(_34f,p));//换成ID
}
}
}
};
...
var _6d7=false;
    //if($(_6d5).val()==_6d6){
if ($(_6d5).val() == _6d6.toString()) {  //更改有True的情况
_6d7=true;
}
